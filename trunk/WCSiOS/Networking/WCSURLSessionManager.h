...
@interface WCSURLSessionManager : NSObject <NSURLSessionDelegate, NSURLSessionDataDelegate>

@property (nonatomic, strong) WCSNetworkingConfiguration *configuration;
