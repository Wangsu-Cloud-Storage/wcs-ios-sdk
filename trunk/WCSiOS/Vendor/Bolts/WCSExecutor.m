...
@interface WCSExecutor ()

@property (nonatomic, copy) void(^block)(void(^block)());

@end

@implementation WCSExecutor

#pragma mark - Executor methods

+ (instancetype)defaultExecutor {
    static WCSExecutor *defaultExecutor = NULL;
...
+ (instancetype)immediateExecutor {
    static WCSExecutor *immediateExecutor = NULL;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
...
+ (instancetype)mainThreadExecutor {
    static WCSExecutor *mainThreadExecutor = NULL;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
