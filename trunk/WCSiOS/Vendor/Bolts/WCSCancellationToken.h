 ...
 */
typedef void(^WCSCancellationBlock)();

/*!
 The consumer view of a CancellationToken.
 Propagates notification that operations should be canceled.
 A WCSCancellationToken has methods to inspect whether the token has been cancelled.
 */
@interface WCSCancellationToken : NSObject
