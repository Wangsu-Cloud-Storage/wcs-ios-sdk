...
FOUNDATION_EXPORT NSString * const WCSxReqidErrorKey;
...
typedef NS_ENUM(NSInteger, WCSClientError) {
  WCSClientErrorUnknown = 0,
  WCSClientErrorInvalidateParameter = 1,
  WCSClientErrorIllegalData = 2,
  WCSClientErrorBlockUploadFailed = 3
};
